        ...
        <div class="row">
          <div class="col-md-9 post-content" data-aos="fade-up">
            ...
            <div class="single-post">
              ...
              <p>{{substr($blog->description,0,10)}}</p>

              <div class="my-4">
                <img src="{{asset($blog->image_name)}}" alt="" class="img-fluid">
                <figcaption>{{substr($blog->description,200)}}</figcaption>
              </div>
              <p></p>
              ...
              <div class="col-lg-12">
                ...
                <form action="{{route('new.comment')}}" method="POST">
                  ...
                  <div class="col-12 mb-3">
                    ...
                    <textarea class="form-control" id="comment-message" name="comment" placeholder="Enter your name" cols="30" rows="10"></textarea>
                  </div>
                  <div class="col-12">
              ...
              <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-popular" role="tabpanel" aria-labelledby="pills-popular-tab">
                  @foreach ($categoryWiseBlogs as $categoryWiseBlog )
                    ...
                    <h2 class="mb-2"><a href="{{route('blog.detlies',['slug'=>$categoryWiseBlog->slug])}}">{{$categoryWiseBlog->title}}</a></h2>
